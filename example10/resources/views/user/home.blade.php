...
<body>
  ...
  <header>
        ...
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              ...
              <a href="#"><span class="mai-mail text-primary"></span> Vin-Mec-mail@example.com</a>
            </div>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="{{ url('home') }}"><span class="text-primary">Vin</span>-Mec</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="btn btn-primary ml-lg-3" href="{{ route('login') }}">Đăng ký</a>
              </li>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>Vin</span>-Mec Nhà thuốc</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1>Chào mừng bạn đến với Vin-Mec<br> Trung tâm</h1>
    ...
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Đối tác</h5>
          <ul class="footer-menu">
            <li><a href="#">Vin-thích hợp </a></li>
            <li><a href="#">Vin-thuốc</a></li>
            <li><a href="#">Vin-Live</a></li>
          </ul>
        </div>
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Liên lạc</h5>
          ...
          <a href="#" class="footer-link">vin-mec@temporary.net</a>
