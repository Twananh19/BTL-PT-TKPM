...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">Vin</span>-Mec</a>
        ...
        <form action="#">
          <div class="input-group input-navbar">
            ...
            <input type="text" class="form-control" placeholder="Tim kiem" aria-label="Username" aria-describedby="icon-addon1">
          </div>
        </form>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Tìm hiểu</a>
            </li>
            <li class="nav-item">
